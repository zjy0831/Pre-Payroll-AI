...
const prePayrollPages = [
  {
    ...
    ai: {
      ...
      actions: ['Mark Resolved', 'Accept Warning', 'Continue to Payroll Variance Predictor'],
    },
  },
  {
    id: 'sd-variance',
  ...
  },
  {
    ...
    accent: 'client',
    subtitle: '客户端现在只查看考勤、请假、OT 和节假日数据块，直接查看对应的 AI 分析、summary 和明细数据。',
    stats: [
    ...
    tabs: ['Leave Attendance Data'],
    activeTab: 'Leave Attendance Data',
    subTabsByTab: {
    ...
    currentView: {
      title: 'Leave Attendance Data',
      caption: '客户当前查看 Leave Attendance Data，直接对照考勤、请假、OT 与节假日记录。',
      stickyLastColumn: false,
      columns: ['Flag', 'Employee Code', 'Employee Name', 'Company Code', 'Company Name', 'Holiday Code', 'Holiday Name', 'Allowance Code', 'Allowance Name', 'Holiday Amount'],
      rows: [
      ...
      anomalies: [
        {
          id: 'client-current-package',
          severity: 'critical',
          summary: 'Leave Attendance 当前仍存在 pending leave impact 和 OT mismatch，客户需要决定是否接受当前 package。',
          outputs: ['Leave impacting pay list', 'OT mismatch report'],
          aiRecommendation: 'Return unresolved attendance items to SD unless explicitly accepted.',
          quickActions: ['Return to SD', 'Open flagged records'],
          title: 'Leave Attendance',
          detail: 'Pending leave and OT issues remain',
          impact: 'May alter payroll result',
